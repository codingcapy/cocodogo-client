    ...
    const router = createBrowserRouter(
        createRoutesFromElements(
            <Route element={<Layout />}>
                ...
                <Route path="/cocodogo-client/maintenance2" element={<MaintenancePage />} />
                <Route path="/cocodogo-client/users/maintenance3" element={<MaintenancePage />} />
                <Route path="/cocodogo-client/users/maintenance4" element={<MaintenancePage />} />
            </Route>
        )
    )
    return router
