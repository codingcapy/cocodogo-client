    ...
    return (
        <header className="sticky z-50 top-0 md:flex justify-between bg-gradient-to-r from-purple-900 to-pink-900 text-white">
            {expandedMenu && <div className="flex flex-col md:flex-row">
                <NavLink to="/cocodogo-client" className="text-center py-4 px-5 mx-auto" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}><div className="flex"><img src={cocodog} className="w-10 h-auto max-w-xs pr-2" /> CocoDogo</div></NavLink>
                <NavLink to="/cocodogo-client" className="flex py-2 md:py-4 mx-auto" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}><IoHomeSharp size={20} className=" text-center mx-2" /> Home</NavLink>
            </div >}
            ...
            {expandedMenu && <div className="flex flex-col md:block md:py-4">
                <NavLink to="/cocodogo-client/posts" className="text-center py-2 md:py-4 px-5" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}>Posts</NavLink>
                {user && <NavLink to="/cocodogo-client/posts/create" className="text-center py-2 md:py-4 px-5" onClick={() => setExpandedMenu(window.innerWidth < 500 ? false : true)}>Create</NavLink>}
            </div>}
            {expandedMenu && <div className="flex flex-col md:block md:py-4">
            ...
            <div className="flex justify-between md:hidden">
                {!expandedMenu && <NavLink to="/cocodogo-client" className="py-2 px-2 md:hidden"><div className="flex"><img src={cocodog} className="w-10 h-auto max-w-xs pr-2" /></div></NavLink>}
